...
private ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       String[] contries=resources.getStringArray(R.array.countries);
        ArrayAdapter arrayAdapter=new ArrayAdapter(this,android.R.layout.simple_dropdown_item_1line,contries);
